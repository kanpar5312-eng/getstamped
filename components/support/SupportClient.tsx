...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Does GetStamped cover UK, Canada, or Australia visas?", a: "Not yet — F-1 (US) only for now. UK Student Visa, Canada Study Permit, and Australia Subclass 500 are on the roadmap. Existing users will be notified first." },
      { q: "Is GetStamped affiliated with the US government?", a: "No. GetStamped is an independent informational tool. We are not affiliated with the US Department of State, USCIS, or any government agency, and we are not immigration attorneys." },
    ],
  },
  {
    id: "features",
    ...
    items: [
      { q: "How does the voice mock interview work?", a: "Pick a scenario (Bachelor's, Master's, PhD), difficulty, and officer style. The AI officer asks questions out loud, you answer with your voice, and it adapts follow-ups based on your answers. You get scored on clarity, confidence, specificity, and officer concern level — with feedback per question." },
      { q: "Which browsers support the voice mock interview?", a: "Chrome, Edge, and Safari. Firefox has limited speech support. We never record your audio — only the text transcript is processed." },
      { q: "How does the AI Q&A work?", a: "Ask anything about your F-1 process — globally or scoped to a specific step. Answers are grounded in the actual process, not generic advice. Free users get 3 questions; paid users get unlimited." },
      { q: "What's the Parent View?", a: "A read-only link your parents can open without any login. They see your progress, current phase, interview countdown, and recent activity — updated live as you complete steps. No more 'have you done it yet?' calls." },
      { q: "Is my document data safe?", a: "Documents are stored encrypted with strict row-level security — only your authenticated account can access your files. We never share, sell, or train on your documents. You can export or delete everything anytime from Settings." },
      { q: "What's the Interview Day Checklist PDF?", a: "One click compiles every document you've uploaded for interview prep into a single labeled, printable PDF — so you walk into the consulate with everything organized in order." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Can I share my account with my sibling?", a: "Accounts are personal — visa data conflicts make sharing a bad idea. Get the Family plan instead: each student gets their own full account at a lower combined price." },
      { q: "How do I delete my account?", a: "Settings → Danger zone → Delete account. There's a 30-day grace period in case you change your mind, then everything is permanently erased. You can export your data first." },
